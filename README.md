...
This repository stores custom Codex Skills.

## Skills

- `stop-slop`: removes common AI-writing patterns from prose and helps rewrite drafts to sound more direct and human.
...
- `project-rebuild-tutor`: creates a guided rebuild roadmap for learning a project.
